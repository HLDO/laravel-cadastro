...
@section('content_header')
    ...
    <div class="page-header">
        <h1>Estados <small>{{ trans('laravel-crud::view.show') }}</small></h1>
        ...
        <a href="{{ URL::to('estados/' . $estado->id . '/edit') }}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="{{ trans('laravel-crud::view.btn-edit') }}">
